...
class TextTool(BaseTool):
    ...
    def on_left_click(self, x: float, y: float) -> bool:
        ...
        # TODO: Add new text at the clicked position (probably needs a dialog for input)
    ...
    def on_double_click(self, x: float, y: float) -> bool:
        ...
        # TODO: Edit existing text on double-click (open text editing dialog)
    ...
    def on_drag_start(self, x: float, y: float, start_x: float, start_y: float) -> bool:
        ...
        # TODO: Initialize drag operation (if text can be repositioned by dragging)
        return False
