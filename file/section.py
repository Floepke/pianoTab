...
class Section(BaseModel):
    ...
    color: Optional[str] = Field(default=None, description="Color, None to inherit from globalSection")
    lineWidth: Optional[float] = Field(default=None, description="Line width, None to inherit from globalSection")
