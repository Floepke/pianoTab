...
class Beam(BaseModel):
    ...
    color: Optional[str] = Field(default=None, description="Color, None to inherit from globalBeam")
    width: Optional[float] = Field(default=None, description="Width, None to inherit from globalBeam")
    slant: Optional[float] = Field(default=None, description="Slant, None to inherit from globalBeam")
    ...
    def __getattribute__(self, name: str):
        ...
        if value is None and name in ['color', 'width', 'slant']:
